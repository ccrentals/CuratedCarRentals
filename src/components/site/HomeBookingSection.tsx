  ...
  return (
    <section className="bg-[var(--ccr-surface-soft)]/55 py-16 md:py-24">
      <Container>
        ...
        <div className="mx-auto mt-12 max-w-5xl rounded-[2rem] border border-[var(--ccr-border)] bg-[var(--ccr-surface)] p-8 shadow-[0_24px_80px_rgba(15,23,42,0.08)] md:p-10">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[var(--ccr-accent-strong)]">
                Integrated Booking
              </p>
              <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--ccr-muted)]">
