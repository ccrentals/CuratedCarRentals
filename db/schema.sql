...
create table if not exists booking_vehicle_inspections (
  ...
  odometer_value int,
  odometer_unit text,
  odometer_corrected_from_value int,
  odometer_correction_reason text,
  odometer_corrected_by_user_id uuid references users(id) on delete set null,
  odometer_corrected_at timestamptz,
  ...
  constraint booking_vehicle_inspections_corrected_odometer_check check (
  ...
  constraint booking_vehicle_inspections_correction_reason_length_check check (
